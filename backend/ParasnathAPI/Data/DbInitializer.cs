    ...
    public static class DbInitializer
    {
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            if (!context.EcoItems.Any())
            {
                ...
                {
                    // Fauna (No Leopard or Hyena)
                    new EcoItem { Name = "Sloth Bear", Type = "fauna", Description = "A myrmecophagous bear species native to the Indian subcontinent, commonly found in the mixed deciduous forests of Parasnath Wildlife Sanctuary.", ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/6/6c/Sloth_Bear_in_Yala_National_Park.jpg" },
                    new EcoItem { Name = "Barking Deer", Type = "fauna", Description = "Also known as the Indian Muntjac, this small deer is known for its distinctive bark-like call and is frequently spotted in the dense undergrowth of the hills.", ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/c/cd/Indian_Muntjac_in_Nagarhole.jpg" },
                    new EcoItem { Name = "Wild Boar", Type = "fauna", Description = "A robust and adaptable species that plays a key ecological role in the forests of Parasnath by turning over soil while foraging.", ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/b/be/Wild_Boar_H%C3%BClser_Berg_02.jpg" },
                    new EcoItem { Name = "Langur", Type = "fauna", Description = "Gray langurs are highly social primates that inhabit the forested slopes of Parasnath, often seen swinging through the canopy or resting near temples.", ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/6/62/Gray_langur_%28Semnopithecus_entellus%29.jpg" },
                    new EcoItem { Name = "Macaque", Type = "fauna", Description = "Rhesus macaques are common around the pilgrimage trails, intelligent and curious monkeys that are familiar with human presence.", ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/9/91/Rhesus_macaque_%28Macaca_mulatta%29_2.jpg" },
                    
                    // Flora
                    new EcoItem { Name = "Sal (Shorea robusta)", Type = "flora", Description = "A dominant tree species in the Parasnath Wildlife Sanctuary, providing dense canopy cover and crucial habitat for numerous wildlife species. It plays a pivotal role in the local ecosystem.", ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/b/b5/Shorea_robusta_tree.jpg" },
                    new EcoItem { Name = "Bamboo", Type = "flora", Description = "Extensive bamboo groves are found throughout the sanctuary, serving as an important food source and shelter for animals, as noted in botanical surveys.", ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/e/e5/Bamboo_forest_Arashiyama.jpg" },
                    new EcoItem { Name = "Teak (Tectona grandis)", Type = "flora", Description = "A valuable deciduous timber tree that thrives in the mixed forests of the region, known for its large leaves and durable wood.", ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/0/07/Tectona_grandis_-_Khao_Yai.jpg" },
                    new EcoItem { Name = "Kalmegh (Andrographis paniculata)", Type = "flora", Description = "An important ethnomedicinal herb found in the local forests, traditionally used by local tribes for its medicinal properties.", ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/4/4e/Andrographis_paniculata.jpg" }
                };
            ...
            if (!context.SiteSettings.Any())
            {
                var settings = new List<SiteSetting>
                {
                    ...
                    new SiteSetting { Key = "HomeAboutTitle", Value = "The Highest Peak of Jharkhand" },
                    new SiteSetting { Key = "HomeAboutText", Value = "Rising 1,366 meters above the plains, Parasnath Hills are located towards the eastern end of the Chota Nagpur Plateau in the Giridih District. It is the highest mountain peak in Jharkhand. Also known as 'Samet Sikhar', the name Parasnath comes from Parshvanatha, the 23rd Tirthankara. It is the sacred ground where 20 out of 24 Jain Tirthankaras attained Nirvana. The mountain is also deeply revered by the local Santhal Tribe who worship the sacred place as 'Marang Buru'." }
                };
